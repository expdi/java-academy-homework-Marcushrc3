...
public class Adopter implements Comparable<Adopter> {
    ...
    // Construtor mínimo
    public Adopter(int id, String adopterName, long phoneNumber, LocalDate dateOfAdoption, AnimalType animalType) {
        this(id, adopterName, "", phoneNumber, dateOfAdoption, "", animalType);
    }
    ...
    public int compareTo(Adopter other) {
        return this.adopterName.compareTo(other.adopterName);
    }
}
